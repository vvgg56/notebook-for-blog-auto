...
- [🆕🔴 발행체계 전환: jgluna용GUI v2.51 + 서버 bizops 레이어](reference_jgluna_gui_v251_bizops.md) — 2026-08-10 TabPublisher→biz워커 교체. 서버 bizops_compat(워커API)+title_biz_ai(제목AI+horizon37 스타일)+딸칵 등록+브랜딩7 분리(타세션)+/remote 브리지, customers 57(엘리트=7월 IP 복원), worker_key=서버 bizops_worker_key.txt
