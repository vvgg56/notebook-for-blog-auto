...
- [🆕🔴 발행체계 전환: jgluna용GUI v2.51 + 서버 bizops 레이어](reference_jgluna_gui_v251_bizops.md) — 2026-08-10 TabPublisher→biz워커 교체. 서버 bizops_compat(워커API)+title_biz_ai(제목AI)+딸칵 등록+브랜딩7 분리(타세션), customers 57·엘리트 59 재배정, worker_key=서버 bizops_worker_key.txt
