...
metadata: 
  ...
  modified: 2026-09-07T08:39:39.438Z
---
...
- **fix = bizops_compat `_repair_generation`(서빙 전 수리, ✅ 9/7 17:39 배포 완료 — 백업 `.bak_20260907_repair`,
  프로덕션 실측: cached 12900090 이 '어미 1곳+소제목 가이→가격+꼬리 제거'로 치유돼 서빙됨. sshd 연속접속 차단은
  '단일 연결에 업로드+적용+검증 몰아넣기+7분 간격 백그라운드 재시도'로 통과)**: ①어미 '…니.'→'…니다.'(입·십은 앞 한글 필수,
